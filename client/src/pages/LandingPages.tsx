      ...
      <div className='max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6'>
        <div className='max-w-screen-md mx-auto mb-8 text-center lg:mb-12'>
          <h2 className='mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white'>
            Conçu pour les équipes d'entreprise comme la vôtre
          </h2>
          <p className='mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400'>
            Chez Landwind, nous nous concentrons sur les marchés où la technologie, l'innovation et
            le capital peuvent débloquer une valeur à long terme et stimuler la croissance
            économique.
          </p>
        </div>
          ...
          {pricingPlans.map((plan, index) => (
            <LandingCard key={index}>
              ...
              <button
                ...
                disabled={processing}
                className='text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white dark:focus:ring-purple-900 disabled:opacity-50'
              >
                {processing ? 'Traitement...' : 'Commencer'}
              </button>
